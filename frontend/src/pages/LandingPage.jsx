  ...
  return (
    <div className={landingPageStyles.container}>
      ...
      <header className={landingPageStyles.header}>
        <div className={landingPageStyles.headerContainer}>
          <div className={landingPageStyles.logoContainer}>
            ...
            <span className={landingPageStyles.logoText}>APlusResumes</span>
          </div>
          {/* Mobile Menu Button */}
          <button
          ...
          <div className={landingPageStyles.ctaContainer}>
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                ...
                <p className={landingPageStyles.ctaDescription}>Join Thousabnds of professionals who landed their dream jobs with our platform</p>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
            <p className={landingPageStyles.footerText}>
                Crafted with <span className={landingPageStyles.footerHeart}>💖</span> Written by Code
      ...
      <Model isOpen={OpenAuthModel} onClose={()=>{
        ...
        <div>
            {currentPage === "login"&& <Login currentpPage={setcurrentPage}/>}
            {currentPage === "signup"&& <SignUp currentpPage={setcurrentPage}/>}
        </div>
      </Model>
    </div>
  );
