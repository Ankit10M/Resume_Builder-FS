  ...
  return (
    <>
      ...
      <div className="relative w-full h-4 bg-white/5 backdrop-blur-2xl overflow-hidden rounded-full border border-white/10">
        ...
        <div
          className="relative h-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-violet-600 animate-flow
      ...
      <div className="flex justify-between items-center mt-3 ml-2 ">
        <div className="text-xs font-bold text-black/60">
          {progress < 25
            ...
            ? "Yess! Step 1 Cleared🎉"
            : progress < 65
            ? "Fill the True Data, Increase the Chance of Shortlisting 🧐"
            :progress < 80
            ? "Yess! only Few Info's Remaining 🥲"
            : progress < 94
            ? " Almost There 🫣"
            : "Nearly Completed👍"}
        </div>
