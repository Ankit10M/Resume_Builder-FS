export const landingPageStyles = {
  ...
  desktopAuthButtonText: "relative cursor-pointer",
  ...
  // Hero section
  heroSection: "max-w-6xl mx-10 px-4 sm:px-6 lg:px-8 py-12 sm:py-20",
  ...
  headingText: "block text-slate-900 text-5xl",
  headingGradient: "block text-5xl bg-gradient-to-r from-violet-600 via-fuchsia-600 to-orange-500 bg-clip-text text-transparent",
  ...
  // Buttons
  primaryButton: "group cursor-pointer relative px-5 py-2 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
  primaryButtonOverlay: " absolute cursor-pointer inset-0 bg-gradient-to-r from-fuchsia-600 to-orange-500 opacity-0 group-hover:opacity-100 transition-opacity",
  primaryButtonContent: "relative flex items-center gap-2 sm:gap-3 text-sm",
  ...
  ctaButton: "group w-2xs h-20 relative px-8 sm:px-12 py-3 sm:py-5 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-black text-lg rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
...
export const inputStyles = {
  ...
  inputField: "w-full  outline-none text-gray-800 placeholder-gray-500 font-medium",
